...
<head>
    ...
    <link href="{{ asset('/assets/node_modules/helium-admin/dist/css/style.css') }}" rel="stylesheet">
    <link href="{{ asset('/assets/node_modules/dropmic/dist/dropmic.css') }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('/assets/node_modules/dropmic/dist/dropmic.js') }}"></script>
    <script>
        var dropmics = [];
